 ...
 */
public class SearchTvFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        t= (TextView) view.findViewById(R.id.txt_search_tv);
        Button button=(Button) view.findViewById(R.id.btn_searchTv);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_searchTv:
                Log.d("Search", t.getText().toString() );
                ((MainActivity)getActivity()).SearchTvResult(t.getText().toString());
                break;
        }
    }
}
