 ...
 */
public class SearchPResultFragment extends BaseFragment {
...
//                startActivity(intent);
        ...
        Call<MovieResponse> call= apiService.searchPerson(API_KEY,searchMovie);
